<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Una volta che il tuo account è cancellato, tutte le risorse e i dati ad esso associati saranno eliminati permanentemente. Prima di procedere con la cancellazione del tuo account, ti invitiamo a scaricare qualsiasi dato o informazione che desideri conservare.') }}
        </p>
    </header>
